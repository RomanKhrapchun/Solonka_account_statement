...
async getClientRecord(debtor) {
    ...
    try {
        ...
        // Перевіряємо що COMMUNITY_NAME існує і не є 'default'
        if (!communityName || communityName === 'default') {
            Logger.warn('enrichPhone: COMMUNITY_NAME не налаштовано або має значення "default"', {
                debtorName: debtor?.name
            });
            return null;
        }
