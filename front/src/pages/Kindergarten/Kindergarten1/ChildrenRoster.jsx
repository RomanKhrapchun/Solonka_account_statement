...
const ChildrenRoster = () => {
    ...
    const {error, status, data, retryFetch} = useFetch('api/kindergarten_1/childrenRoster/filter', {
        method: 'post',
    ...
    useEffect(() => {
        ...
        retryFetch('api/kindergarten_1/childrenRoster/filter', {
            method: 'post',
            data: stateChildren.sendData
        });
    ...
    const handleSaveChild = async () => {
        ...
        try {
            await fetchFunction('api/kindergarten_1/childrenRoster', {
                method: 'POST',
                data: {
    ...
    const handleUpdateChild = async () => {
        ...
        try {
            await fetchFunction(`api/kindergarten_1/childrenRoster/${editModalState.childId}`, {
                method: 'PUT',
                data: {
                    child_name: child_name.trim(),
                    parent_name: parent_name.trim(),
    ...
    const handleDeleteChild = async () => {
        ...
        try {
            await fetchFunction(`api/kindergarten_1/childrenRoster/${deleteModalState.childId}`, {
                method: 'DELETE'
            });
