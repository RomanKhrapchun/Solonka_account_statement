...
const Attendance = () => {
    ...
    const {error, status, data, retryFetch} = useFetch('api/kindergarten_2/attendance/filter', {
        method: 'post',
    ...
    useEffect(() => {
        ...
        retryFetch('api/kindergarten_2/attendance/filter', {
            method: 'post',
            data: stateAttendance.sendData
        });
    ...
    const toggleAttendance = async (record) => {
        ...
        try {
            if (record.attendance_id) {
                await fetchFunction(`api/kindergarten_2/attendance/${record.attendance_id}`, {
                    method: 'PUT',
                    data: {
                ...
                await fetchFunction('api/kindergarten_2/attendance', {
                    method: 'POST',
                    data: {
                        date: currentDate,
