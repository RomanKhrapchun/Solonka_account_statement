...
import { processDebtorRegister, sendEmailTask, previewDatabaseUpdate, updateDatabaseExecute } from '../../services/taskApi';

let COMMUNITY_NAME = 'Default Community';
const communityNamePromise = import('../../utils/communityConstants')
    .then(module => {
        COMMUNITY_NAME = module.COMMUNITY_NAME;
        return module.COMMUNITY_NAME;
    })
    .catch(error => {
        console.log('Використовуємо fallback');
...
const DebtorList = () => {
        ...
        const [communityName, setCommunityName] = useState('Default Community');
        const [isCommunityNameLoaded, setIsCommunityNameLoaded] = useState(false);
        ...
        useEffect(() => {
            communityNamePromise.then(name => {
                setCommunityName(name);
                setIsCommunityNameLoaded(true);
            });
        }, []);
        ...
        const handleDatabaseUpdateClick = async () => {
            ...
            try {
                ...
                // Викликаємо новий API для preview
                const result = await previewDatabaseUpdate(communityName);
        ...
        const handleConfirmDatabaseUpdate = async () => {
            try {
                ...
                const result = await updateDatabaseExecute(communityName);
                ...
                notification({
                    ...
                    placement: 'top',
                    title: 'Успішно!',
                    message: `База даних оновлена. Завантажено ${result.inserted_debtors} боржників з ${result.source_records} записів`,
                    duration: 5
                });
